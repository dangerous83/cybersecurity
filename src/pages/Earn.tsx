  ...
  return (
    <div className="min-h-screen bg-[#0b0b0e]">
      ...
      <section className="relative overflow-hidden border-b border-[#1a1a1e]">
        <div className="absolute top-0 left-1/3 w-[500px] h-[300px] bg-[#f0b90b]/5 blur-[100px] rounded-full" />
        <div className="relative max-w-[1600px] mx-auto px-4 py-16 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#f0b90b]/10 text-[#f0b90b] text-sm mb-4">
            <Percent className="w-4 h-4" /> Earn up to 120% APY
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">
            Put Your <span className="gold-text">Crypto to Work</span>
          </h1>
          <p className="text-gray-400 max-w-xl mx-auto mb-8">
            Earn passive income on your crypto assets with flexible and locked staking options.
          </p>
          <Button size="lg" className="gold-gradient text-black font-bold px-8">
      ...
      <section className="max-w-[1600px] mx-auto px-4 py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
          {earnProducts.map(product => (
            <div
              key={product.type}
              className="bg-[#0d0d10] border border-[#1a1a1e] rounded-2xl p-5 hover:border-[#f0b90b]/20 transition-all group"
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className={`text-xs px-2 py-0.5 rounded ${
                  ...
                  product.risk === 'Medium' ? 'bg-[#f0b90b]/10 text-[#f0b90b]' :
              ...
              <div className="text-3xl font-bold gold-text mb-3">{product.apy}</div>
              ...
              <Button variant="outline" className="w-full border-[#2a2a2e] text-white hover:bg-[#f0b90b]/10 hover:text-[#f0b90b] hover:border-[#f0b90b]/30">
                Subscribe
              </Button>
            </div>
          ))}
      ...
      <section className="max-w-[1600px] mx-auto px-4 py-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {topAssets.map(asset => {
            ...
            return (
              <div key={asset.id} className="bg-[#0d0d10] border border-[#1a1a1e] rounded-2xl p-5 flex items-center justify-between hover:border-[#f0b90b]/20 transition-all">
                ...
                <Button size="sm" className="gold-gradient text-black font-semibold text-xs">
                  Stake
                </Button>
              </div>
            );
        ...
        <div className="grid sm:grid-cols-3 gap-8 max-w-3xl mx-auto">
          {[
            ...
            <div key={item.step} className="text-center">
              <div className="w-14 h-14 rounded-2xl bg-[#f0b90b]/10 flex items-center justify-center mx-auto mb-4">
                <item.icon className="w-7 h-7 text-[#f0b90b]" />
              </div>
              <div className="text-sm text-[#f0b90b] font-semibold mb-1">Step {item.step}</div>
