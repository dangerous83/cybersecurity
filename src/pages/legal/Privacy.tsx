  ...
  <div className="min-h-screen bg-[#0b0b0e]">
    ...
    <section className="max-w-[900px] mx-auto px-4 py-12 space-y-8">
      {[
        ...
        { title: "9. Children's Privacy", content: "ALCON services are not intended for individuals under 18 years of age. We do not knowingly collect personal information from children. If we become aware that we have collected data from a minor, we will promptly delete it." },
        { title: "10. Changes to This Policy", content: "We may update this Privacy Policy periodically. Material changes will be communicated via email and in-app notification at least 30 days before taking effect. Continued use of ALCON after changes constitutes acceptance of the updated policy." },
        { title: "11. Contact Us", content: "For privacy-related inquiries: Email: privacy@alcon.com | Data Protection Officer: dpo@alcon.com | Mailing Address: ALCON Pte. Ltd., 1 Raffles Place, #20-61, Singapore 048616" },
      ].map(section => (
