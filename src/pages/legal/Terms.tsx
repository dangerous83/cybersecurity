const Terms = () => (
  <div className="min-h-screen bg-[#0b0b0e]">
    ...
    <section className="max-w-[900px] mx-auto px-4 py-12 space-y-8">
      {[
        { title: "1. Acceptance of Terms", content: "By accessing or using ALCON's services, you agree to be bound by these Terms of Service, our Privacy Policy, and all applicable laws and regulations. If you do not agree with any part of these terms, you must not use our services. These terms constitute a legally binding agreement between you and ALCON Pte. Ltd." },
        { title: "2. Eligibility", content: "You must be at least 18 years old (or the age of majority in your jurisdiction) to use ALCON. You must not be a resident of any jurisdiction where cryptocurrency trading is prohibited. You must complete identity verification (KYC) before accessing trading features. We reserve the right to refuse service to anyone at our discretion." },
        ...
        { title: "8. Intellectual Property", content: "All content, software, and technology on ALCON are owned by or licensed to ALCON Pte. Ltd. and protected by intellectual property laws. You may not copy, modify, distribute, or reverse-engineer any part of our platform. The ALCON name, logo, and brand elements are registered trademarks." },
        { title: "9. Limitation of Liability", content: "To the maximum extent permitted by law, ALCON shall not be liable for: trading losses, system downtime or delays, unauthorized access resulting from your negligence, losses due to blockchain network issues, or any indirect, consequential, or punitive damages. Our total liability is limited to the fees you paid in the preceding 12 months." },
        ...
        { title: "13. Contact", content: "For questions about these Terms: legal@alcon.com | ALCON Pte. Ltd., 1 Raffles Place, #20-61, Singapore 048616" },
      ].map(section => (
